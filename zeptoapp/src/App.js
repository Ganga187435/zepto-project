...
const data= [
  ...
  {
    id:"6",
    imagePath:"https://cdn.zeptonow.com/production///tr:w-210,ar-325-425,pr-true,f-webp,q-80/inventory/category/4cfc43e9-78b8-419c-8d03-6d0adcfa8729-imageWithName"
  },
  {
    id:"7",
...
function App() {
  return (
   <div>
     ...
     {/* <main>
      ...
      <nav class="navbar"><h1>Zepto</h1>
        <ul>
          ...
          <li><a href="/My Account">My Accountt</a></li>
          <li><a href="/My Cart"><button className='Mycart'>MyCart</button></a></li>
        </ul>
        </nav> */}
    ...
    <h1>Explore By Categories

See All

right arrow
</h1> 
    {/* <img src={data[0].imagePath} alt='vegetable' />
    <img src={data[1].imagePath} alt='vegetable' />
    <img src={data[2].imagePath} alt='vegetable' />
    <img src={data[3].imagePath} alt='vegetable' />
